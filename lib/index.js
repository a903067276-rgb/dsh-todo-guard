...
export function apply(ctx) {
  ...
  // 注册「最后有效 todo」保留投影：官方 todos 单元在 turn/start 时把状态清成
  // null（每轮开始要求 agent 重写；面板与恢复会话在 null 时整块不渲染——官方
  // 设计语义，TodoPanel 注释 "absent or null renders nothing"）。本单元镜像
  // 官方 todo/write 的 last-wins 全量替换，但不清空：面板跨 turn 延续显示，
